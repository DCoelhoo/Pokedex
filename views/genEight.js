...
export default function genEight({ navigation }) {

	let [fontsLoaded] = useFonts({
		'Flexo-Medium': require('../assets/fonts/Flexo-Medium.ttf'),
	});

	const url = "https://pokeapi.co/api/v2/pokemon?limit=89&offset=809";
		...
		return (
			<ImageBackground source={imageBG} style={styles.bgContainer} blurRadius={1}>
				<View style={styles.titleContainer}>
					...
					<Text style={styles.textTitle}>Eighth Generation</Text>
